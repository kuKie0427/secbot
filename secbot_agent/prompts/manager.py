...
import json
import yaml
from secbot_agent.prompts.chain import PromptChain, PromptChainBuilder
from secbot_agent.database.manager import DatabaseManager
from secbot_agent.database.models import PromptChainModel
...
class PromptManager:
    ...
    def __init__(
        ...
        self.prompts_dir = prompts_dir or (Path(__file__).resolve().parent / "templates")
